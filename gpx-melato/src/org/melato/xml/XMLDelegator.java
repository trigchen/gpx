...
public class XMLDelegator {
	 ...
	 * @param rootHandler
	 *            The root handler. This handler should
	 *            expect a child element for the top element of the file.
	 * @param in
	 *            The input stream containing the XML content.
	 * @throws IOException
	 * @throws SAXException
	 */
	public static void parse(XMLElementHandler rootHandler, File file) throws IOException, SAXException {
	 ...
	 * @throws SAXException
	 */
	public static void parse(XMLElementHandler rootHandler, InputStream in) throws IOException, SAXException {
